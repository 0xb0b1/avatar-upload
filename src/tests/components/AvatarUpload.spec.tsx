...
describe('Avatar Upload', () => {
  ...
  it('should have an avatar to edit', () => {
    ...
    render(
      <ImageContext.Provider value={{ image, imageState }}>
        <AvatarUpload />
      </ImageContext.Provider>,
    )
  ...
  it('should be able to select an image from input', () => {
    ...
    render(
      <ImageContext.Provider value={{ handleFileChange, imageState }}>
        <AvatarUpload />
      </ImageContext.Provider>,
    )
  ...
  it('should show an saved image if the user saved the image', () => {
    const imageState = 'initial'
    const image =
      'data:image/png;base64,'
    ...
    const uploadedAvatarElement = screen.getByTestId('uploaded-avatar')
  ...
  it('should be able to save the edited avatar', () => {
    ...
    render(
      <ImageContext.Provider value={{ image, imageState, handleImageState }}>
        <AvatarUpload />
      </ImageContext.Provider>,
    )
  ...
  it('should close edit by clicking on the X button to restart the process', () => {
    ...
    render(
      <ImageContext.Provider value={{ imageState, handleCancelEdit }}>
        <AvatarUpload />
      </ImageContext.Provider>,
    )
